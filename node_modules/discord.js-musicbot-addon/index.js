    ...
    class Music {
      ...
      checkVoice(mem, bot) {
        return new Promise((resolve, reject) => {
          ...
          if (!mem.voiceChannel) reject("Please enter a voice channel!");
          if (bot.voiceChannel) {
    ...
    musicbot.helpFunction = (msg, suffix, args) => {
      ...
      if (!suffix) {
        if (msg.channel.permissionsFor(msg.guild.me)
          ...
          embed.setDescription(`Use \`${prefix}${musicbot.help.name} command name\` for help on usage.`);
          ...
          var cmdmsg = `= Music Commands =\nUse ${prefix}${musicbot.help.name} [command] for help on a command.\n`;
          let index = 0;
          let max = musicbot.commandsArray.length;
          for (var i = 0; i < musicbot.commandsArray.length; i++) {
